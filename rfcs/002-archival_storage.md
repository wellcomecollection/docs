...
![architecture diagram](../.gitbook/assets/storageservice-20190320.png)

* Assets are first uploaded to an ingest bucket in S3
  * These assets are packaged in `.tar.gz` files in the [BagIt format](https://en.wikipedia.org/wiki/BagIt), a Library of Congress standard for storing collections of digital files
...
Assets will be stored in the above spaces inside the BagIt bags that were transferred for ingest. Unlike during transfer, bags will be stored uncompressed. BagIt is a standard archival file format: [https://tools.ietf.org/html/rfc8493](https://tools.ietf.org/html/rfc8493)
