...
In both this case and the toggles, they're cookies and therefore they expire. But we set them for a year, so we should make sure they're set for way longer. 
